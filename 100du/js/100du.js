...
$(function (){
	...
	(function (){
		...
		var iH = 0;
		var arrData = [
			{ 'name':'张雯', 'time':4, 'title':'美人鱼成限制级', 'url':'http://news.baidu.com/' },
			{ 'name':'畅畅', 'time':5, 'title':' 中国驻韩大使：萨德', 'url':'http://news.baidu.com/' },
			{ 'name':'萱萱', 'time':6, 'title':'国台办回应王郁琦', 'url':'http://news.baidu.com/' },
			{ 'name':'露露', 'time':7, 'title':' 北京5年内将建3.5环 ', 'url':'http://news.baidu.com/' },
			{ 'name':'张三', 'time':8, 'title':' 古巴领导人兄长逝世 ', 'url':'http://news.baidu.com/' },
			{ 'name':'畅畅', 'time':9, 'title':'火影忍者》票房离谱，原因竟然是它', 'url':'http://news.baidu.com/' },
			{ 'name':'李四', 'time':10, 'title':'钟丽缇美人鱼旧照', 'url':'http://news.baidu.com/' },
			{ 'name':'王五', 'time':11, 'title':'法官辞职信走红', 'url':'http://news.baidu.com/' }
		];
		var str = '';
